  ...
  return (
    <>
      ...
      <div className='mission__container'>
        ...
        <BlankCard text="As Americans, Democracy is a responsibility that we are born into. But many of us shirk our civic duty because simply put, it's a pain. Most of us hardly have time to cook dinner, much less dig up our senator's contacts and give them a call. That's where The Democracy Project comes in. Our mission is to offer streamlined solutions to a few simple questions:" />
        ...
        <BlankCard text="In recent years it has become apparent that our polling system is deeply flawed. Many question whether it can be trusted to yield meaningful insight about the electorate. Instead of polling 10 or 30 thousand people, The Democracy Project gives millions a way to express their positions directly and in real time." />
